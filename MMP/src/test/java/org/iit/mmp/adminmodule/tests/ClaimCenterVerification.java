...
public class ClaimCenterVerification extends BaseClass{
	...
	@Test
	public void patientClaim() throws InterruptedException{
		...
		helperObject.patientLogin("ria1", "Ria12345", "http://96.84.175.78/MMP-Release2-Integrated-Build.6.8.000/portal/login.php");
		...
		//creating javascriptexecutor object for scrolling up,so Logout tab is visible
		...
		usersPageObject.adminLogin("Thomas_444", "Edison_444");
		...
		//Compare both HashMap to verify data is same on Patient Module and Admin module
		...
		//Submit a Claim
		submitAClaimPageObject.claimDetails("Beth", 400, 400, 401, "BCBS");
		}
	}
